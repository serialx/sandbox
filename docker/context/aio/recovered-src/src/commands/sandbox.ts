...
var IS_SANDBOX_BUILD = true ? true : false;
function getProviderFromContext(flagOverrides) {
...
function createSandboxCommand(getClient2, getOpts, in_sandbox2, overrides = {}) {
