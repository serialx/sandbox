import { detectContainerRuntime, execCmd } from "../platform.js";
export var LABEL_KEY = "aio-sandbox";
export var CONTAINER_PREFIX = "aio-";
export var DEFAULT_IMAGE = "sandbox:latest";
export var DEFAULT_PORT = 8080;
export var ContainerProvider = class _ContainerProvider {
  constructor(bin) {
    this.bin = bin;
  }
  static detect() {
