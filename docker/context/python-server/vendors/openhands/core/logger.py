...
# Configure LLM logging based on DEBUG_LLM (kept for compatibility but no litellm)
if DEBUG_LLM:
    confirmation = input(
...
# Use LOG_DIR env var + openhands_logs subdirectory, fallback to /tmp
# The original design used relative path to source code, which fails in site-packages
LOG_DIR = os.path.join(os.getenv('LOG_DIR', '/tmp'), 'openhands_logs')
