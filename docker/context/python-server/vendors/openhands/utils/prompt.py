...
from vendors.openhands.controller.state.state import State
from vendors.openhands.core.message import Message, TextContent
from vendors.openhands.events.observation.agent import MicroagentKnowledge
...
class PromptManager:
    ...
    def get_system_message(self) -> str:
        from vendors.openhands.agenthub.codeact_agent.tools.prompt import refine_prompt
